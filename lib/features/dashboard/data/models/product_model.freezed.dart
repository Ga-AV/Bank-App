...
@override
String toString() {
  return 'ProductModel(id: $id, accountNumber: $accountNumber, productName: $productName, balance: $balance)';
}
...
class _ProductModel extends ProductModel {
  const _ProductModel({required this.id, required this.accountNumber, required this.productName, required this.balance}): super._();
